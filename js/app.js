...
function iniciarSliderPromos() {
  promoIndex = 0;
  const track = document.getElementById("promosGrid");
  const cards = document.querySelectorAll(".promo-card-pro");
  ...
  promoInterval = setInterval(moverSlider, 3000);
